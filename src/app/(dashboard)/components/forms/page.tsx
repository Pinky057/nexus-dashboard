    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <div>
            <h2 className="text-base font-semibold text-zinc-100">Contact Form</h2>
          ...
          <div>
            ...
            <select className="block w-full rounded-md border-0 bg-zinc-950 py-2 pl-3 pr-10 text-zinc-100 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none transition-all">
          ...
          <div>
            ...
            <textarea rows={4} placeholder="Write your message here..." className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 placeholder-zinc-600 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none transition-all resize-none" />
          </div>
          <button className="w-full rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-indigo-500 transition-colors">
            Send Message
          </button>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
          ...
          <div className="flex items-center gap-4">
            <div className="h-16 w-16 rounded-full bg-indigo-600 flex items-center justify-center text-zinc-100 text-xl font-bold shrink-0">P</div>
            <div>
              <button className="rounded-md bg-zinc-800 px-3 py-1.5 text-sm font-medium text-zinc-100 hover:bg-zinc-700 transition-colors">Change Photo</button>
          ...
          <div>
            ...
            <input type="text" defaultValue="Admin User" className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none transition-all" />
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1.5">Email</label>
            <input type="email" defaultValue="admin@synthex.io" className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none transition-all" />
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1.5">Password</label>
            <div className="relative">
              <input type={showPassword ? "text" : "password"} defaultValue="supersecret123" className="block w-full rounded-md border-0 bg-zinc-950 py-2 pl-3 pr-10 text-zinc-100 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none transition-all" />
          ...
          <div className="flex gap-3 pt-2">
            <button className="flex-1 rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-indigo-500 transition-colors">Save Changes</button>
            <button className="rounded-md bg-zinc-800 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-zinc-700 transition-colors">Cancel</button>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-5">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Input States & Variants</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <input type="text" placeholder="Default input" className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 placeholder-zinc-600 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none" />
          </div>
          <div>
            <label className="block text-sm font-medium text-emerald-400 mb-1.5">Success</label>
            <input type="text" defaultValue="Valid value" className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 ring-1 ring-inset ring-emerald-500 focus:ring-2 focus:ring-emerald-500 sm:text-sm outline-none" />
          ...
          <div>
            ...
            <input type="text" defaultValue="invalid@" className="block w-full rounded-md border-0 bg-zinc-950 py-2 px-3 text-zinc-100 ring-1 ring-inset ring-rose-500 focus:ring-2 focus:ring-rose-500 sm:text-sm outline-none" />
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search users, orders, data..." className="block w-full rounded-md border-0 bg-zinc-950 py-2 pl-9 pr-3 text-zinc-100 placeholder-zinc-600 ring-1 ring-inset ring-zinc-800 focus:ring-2 focus:ring-indigo-600 sm:text-sm outline-none" />
            </div>
          </div>
        </div>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-5">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Checkboxes & Radio Buttons</h2>
