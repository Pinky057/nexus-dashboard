  ...
  return (
    <>
      ...
      <motion.aside
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex flex-col p-5 lg:static lg:translate-x-0",
                      ...
                      <div key={item.name} className="space-y-1">
                        {hasSubItems ? (
                          <button
                            ...
                            className={cn(
                              "w-full group flex items-center gap-3 rounded-2xl py-3.5 text-sm font-semibold transition-all duration-200",
