  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
        ...
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Solid Variants</h2>
          <p className="text-xs text-zinc-500 mt-1">Use for primary actions, confirmations, and CTA buttons.</p>
        </div>
        <div className="flex flex-wrap gap-3">
          <button className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-indigo-500 transition-colors">Primary</button>
          <button className="rounded-md bg-zinc-800 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-zinc-700 transition-colors">Secondary</button>
          <button className="rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-emerald-500 transition-colors">Success</button>
          <button className="rounded-md bg-rose-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-rose-500 transition-colors">Danger</button>
          <button className="rounded-md bg-amber-500 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-amber-400 transition-colors">Warning</button>
          <button className="rounded-md bg-sky-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-sky-500 transition-colors">Info</button>
        </div>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Outline Variants</h2>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Ghost / Soft Variants</h2>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button className="rounded-md px-4 py-2 text-sm font-semibold text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100 transition-colors">Plain Ghost</button>
        </div>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">With Icons</h2>
          <p className="text-xs text-zinc-500 mt-1">Pair icons with labels for clarity and visual interest.</p>
        </div>
        <div className="flex flex-wrap gap-3">
          <button className="inline-flex items-center gap-2 rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-indigo-500 transition-colors">
            <Plus className="h-4 w-4" /> Add New
          </button>
          <button className="inline-flex items-center gap-2 rounded-md bg-zinc-800 px-4 py-2 text-sm font-semibold text-zinc-100 hover:bg-zinc-700 transition-colors">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">State Variants</h2>
          <p className="text-xs text-zinc-500 mt-1">Loading, success, and disabled states for async actions.</p>
        </div>
        <div className="flex flex-wrap gap-3">
          <button disabled className="inline-flex items-center gap-2 rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-zinc-100 opacity-50 cursor-not-allowed">
            <Loader2 className="h-4 w-4 animate-spin" /> Loading...
          </button>
          <button className="inline-flex items-center gap-2 rounded-md bg-emerald-600 px-4 py-2 text-sm font-semibold text-zinc-100 cursor-default">
            <Check className="h-4 w-4" /> Success
          </button>
          <button className="inline-flex items-center gap-2 rounded-md bg-rose-600 px-4 py-2 text-sm font-semibold text-zinc-100 cursor-default">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}
        className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4">
        <div>
          <h2 className="text-base font-semibold text-zinc-100">Sizes</h2>
          <p className="text-xs text-zinc-500 mt-1">Available in xs, sm, md, lg, and xl sizes.</p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          <button className="rounded px-2 py-1 text-xs font-semibold bg-indigo-600 text-zinc-100 hover:bg-indigo-500 transition-colors">XSmall</button>
          <button className="rounded-md px-3 py-1.5 text-sm font-semibold bg-indigo-600 text-zinc-100 hover:bg-indigo-500 transition-colors">Small</button>
          <button className="rounded-md px-4 py-2 text-sm font-semibold bg-indigo-600 text-zinc-100 hover:bg-indigo-500 transition-colors">Medium</button>
          <button className="rounded-lg px-5 py-2.5 text-base font-semibold bg-indigo-600 text-zinc-100 hover:bg-indigo-500 transition-colors">Large</button>
          <button className="rounded-xl px-6 py-3 text-lg font-semibold bg-indigo-600 text-zinc-100 hover:bg-indigo-500 transition-colors">XLarge</button>
        </div>
      </motion.div>
