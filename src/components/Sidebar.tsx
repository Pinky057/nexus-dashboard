      ...
      >
        <div className="flex h-full flex-col relative scrollbar-hide">
          ...
          <button 
            ...
            className={cn(
              "absolute top-28 hidden lg:flex h-8 w-8 items-center justify-center rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 shadow-xl z-[70]",
          ...
          {/* Sidebar Panel */}
          <div className="flex h-full flex-col rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800/50 bg-white/80 dark:bg-zinc-900/40 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_30px_60px_rgba(0,0,0,0.6)] overflow-visible scrollbar-hide transition-colors duration-500">
                              ...
                              <div className="relative">
                                ...
                                {isCollapsed && (
                                  <div className="absolute left-[calc(100%+0.5rem)] top-0 invisible opacity-0 group-hover/item:visible group-hover/item:opacity-100 transition-all duration-300 z-[100] translate-x-2 group-hover/item:translate-x-0">
                                    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800/50 backdrop-blur-3xl rounded-[2rem] p-2 w-56 shadow-2xl">
                                      <div className={cn(
                                        "flex items-center gap-3 px-4 py-3.5 rounded-2xl mb-2",
                                        isActive ? "bg-indigo-600 text-white shadow-lg shadow-indigo-500/30" : "bg-zinc-100 dark:bg-zinc-800/50 text-zinc-900 dark:text-zinc-100"
                                      )}>
